      ...
      <div className="mx-auto max-w-7xl grid gap-4 md:gap-6 grid-cols-1 md:grid-cols-3">
          <div
            ...
            <div className="absolute bottom-4 left-4 right-4">
              <h3 className="text-white font-semibold text-sm bg-black/50 px-3 py-1 rounded-full backdrop-blur-sm">
                {videos[0].title}
              </h3>
            </div>
            ...
            <div className="absolute bottom-4 right-4 z-10">
              <button className="flex h-10 w-10 items-center justify-center rounded-full bg-red-700 text-white transition hover:bg-red-600">
            ...
            <div className="absolute bottom-3 left-3 right-3">
              <h3 className="text-white font-medium text-xs bg-black/50 px-2 py-1 rounded-full backdrop-blur-sm">
                {videos[2].title}
              </h3>
            </div>
